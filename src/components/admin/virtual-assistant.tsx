...
const VirtualAssistance: FC<TProps> = ({ fitness }) => {
  ...
  const [virtualAssistanceInput, setVirtualAssistanceInput] = useState(
    fitness.virtualAssistance
  );
  ...
  return (
    <>
      ...
      <Modal toggle={toggleModal} isOpen={isModalOpen} size="xl">
        ...
        <ModalFooter>
          <Button color="primary" onClick={saveVirtualAssistance}>
            Save
          </Button>{" "}
